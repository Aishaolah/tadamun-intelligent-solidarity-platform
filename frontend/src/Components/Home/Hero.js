    ...
    return (
        <div className='mt-32 mb-20'>
            ...
            <div className='grid grid-cols-1 gap-15 content-evenly pl-10 '>
                ...
                <p className='text-[#EFEBE3] text-xl font-bold'>Intelligent Solidarity Platform</p>
                ...
                {/* AI VERIFICATION BUTTON - ADDED */}
                <Link href="/demo">
                    <button className='text-[#1E3231]/75 bg-[#A0E5AD] rounded-lg px-5 py-2 hover:bg-[#78F392] hover:border-transparent hover:shadow-lg-[0_0_20px_rgba(120, 243, 146, 1)] transition duration-300 hover:scale-102 font-bold flex items-center gap-2'>
                        <span>🤖</span>
